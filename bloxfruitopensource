...
local mainfarm = Window:CreateTab({
    Name = "Main Farm",
    Icon = "eco",
    ImageSource = "Material",
    ShowTitle = true
})
local subfarm = Window:CreateTab({
    Name = "Subs Farm",
    Icon = "agriculture",
    ImageSource = "Material",
    ShowTitle = true
})
local quest = Window:CreateTab({
    Name = "Quest",
    Icon = "flag",
    ImageSource = "Material",
    ShowTitle = true
})
local dojoo = Window:CreateTab({
    Name = "Dragon Dojo",
    Icon = "gavel", 
    ImageSource = "Material",
    ShowTitle = true
})
local seas = Window:CreateTab({
    Name = "Sea Event",
    Icon = "anchor", 
    ImageSource = "Material",
    ShowTitle = true
})
local v4 = Window:CreateTab({
    Name = "Race V4",
    Icon = "verified_user",
    ImageSource = "Material",
    ShowTitle = true
})
local raid = Window:CreateTab({
    Name = "Raids",
    Icon = "group_work", 
    ImageSource = "Material",
    ShowTitle = true
...
local Dropdown = mainfarm:CreateDropdown({
	Name = "Select Weapon",
    Description = nil,
...
spawn(function()
    while task.wait() do
        pcall(function()
            Farm_Mode = CFrame.new(0,DistanceFarm,0)
        end)
    end
end)
...
setting:CreateParagraph({
    Title = "Effects Inside The Game",
    Text = "Effects Inside The Game",
})
setting:CreateToggle({
...
local DojoProgessCheck = dojoo:CreateLabel({
    Text = '',
    Style = 1
})
local DojoInfoCheck = dojoo:CreateLabel({
    Text = '',
    Style = 1
})
task.spawn(function()
    while task.wait() do
        if getAcc("Dojo Belt (White)") == false and getAcc("Dojo Belt (Yellow)") == false and getAcc("Dojo Belt (Orange)") == false and getAcc("Dojo Belt (Green)") == false and getAcc("Dojo Belt (Blue)") == false and getAcc("Dojo Belt (Purple)") == false and getAcc("Dojo Belt (Red)") == false and getAcc("Dojo Belt (Black)") == false then
            DojoProgessCheck:Set("Dojo Progress : Get Dojo Belt (White)")
            DojoInfoCheck:Set("Kill 20 NPC on Quest")
        ...
        elseif getAcc("Dojo Belt (White)") == true and getAcc("Dojo Belt (Yellow)") == false and getAcc("Dojo Belt (Orange)") == false and getAcc("Dojo Belt (Green)") == false and getAcc("Dojo Belt (Blue)") == false and getAcc("Dojo Belt (Purple)") == false and getAcc("Dojo Belt (Red)") == false and getAcc("Dojo Belt (Black)") == false then
            DojoProgessCheck:Set("Dojo Progress : Get Dojo Belt (Yellow)")
            DojoInfoCheck:Set("Kill 5 Shark/Piranha/Fishcrew Member")
        ...
        elseif getAcc("Dojo Belt (White)") == true and getAcc("Dojo Belt (Yellow)") == true and getAcc("Dojo Belt (Orange)") == false and getAcc("Dojo Belt (Green)") == false and getAcc("Dojo Belt (Blue)") == false and getAcc("Dojo Belt (Purple)") == false and getAcc("Dojo Belt (Red)") == false and getAcc("Dojo Belt (Black)") == false then
            DojoProgessCheck:Set("Dojo Progress : Get Dojo Belt (Orange)")
            DojoInfoCheck:Set("Complete 1 Trade with another Player")
        ...
        elseif getAcc("Dojo Belt (White)") == true and getAcc("Dojo Belt (Yellow)") == true and getAcc("Dojo Belt (Orange)") == true and getAcc("Dojo Belt (Green)") == false and getAcc("Dojo Belt (Blue)") == false and getAcc("Dojo Belt (Purple)") == false and getAcc("Dojo Belt (Red)") == false and getAcc("Dojo Belt (Black)") == false then
            DojoProgessCheck:Set("Dojo Progress : Get Dojo Belt (Green)")
            DojoInfoCheck:Set("Travel to Sea Danger Level 4-6 \n and stay there for 5 minutes.")
        ...
        elseif getAcc("Dojo Belt (White)") == true and getAcc("Dojo Belt (true)") == false and getAcc("Dojo Belt (Orange)") == true and getAcc("Dojo Belt (Green)") == true and getAcc("Dojo Belt (Blue)") == false and getAcc("Dojo Belt (Purple)") == false and getAcc("Dojo Belt (Red)") == false and getAcc("Dojo Belt (Black)") == false then
            DojoProgessCheck:Set("Dojo Progress : Get Dojo Belt (Blue)")
            DojoInfoCheck:Set("Collect a fruit dropped by another player")
        ...
        elseif getAcc("Dojo Belt (White)") == true and getAcc("Dojo Belt (Yellow)") == true and getAcc("Dojo Belt (Orange)") == true and getAcc("Dojo Belt (Green)") == true and getAcc("Dojo Belt (Blue)") == true and getAcc("Dojo Belt (Purple)") == false and getAcc("Dojo Belt (Red)") == false and getAcc("Dojo Belt (Black)") == false then
            DojoProgessCheck:Set("Dojo Progress : Get Dojo Belt (Purple)")
            DojoInfoCheck:Set("Kill 3 Elite Pirates")
        ...
        elseif getAcc("Dojo Belt (White)") == true and getAcc("Dojo Belt (Yellow)") == true and getAcc("Dojo Belt (Orange)") == true and getAcc("Dojo Belt (Green)") == true and getAcc("Dojo Belt (Blue)") == true and getAcc("Dojo Belt (Purple)") == true and getAcc("Dojo Belt (Red)") == false and getAcc("Dojo Belt (Black)") == false then
            DojoProgessCheck:Set("Dojo Progress : Get Dojo Belt (Red)")
            DojoInfoCheck:Set("Defeat a Terrorshark or Rumbling Waters Sea Event.")
        ...
        elseif getAcc("Dojo Belt (White)") == true and getAcc("Dojo Belt (Yellow)") == true and getAcc("Dojo Belt (Orange)") == true and getAcc("Dojo Belt (Green)") == true and getAcc("Dojo Belt (Blue)") == true and getAcc("Dojo Belt (Purple)") == true and getAcc("Dojo Belt (Red)") == true and getAcc("Dojo Belt (Black)") == false then
            DojoProgessCheck:Set("Dojo Progress : Get Dojo Belt (Black)")
            DojoInfoCheck:Set("Complete Prehistoric Island event \n and collect 3 Dinosaur bones")
        end
        wait(300)
    end
end)
...
dojoo:CreateToggle({
    Name = "Destroy Tree + Collect Ember",
    Description = nil,
    CurrentValue = false,
    Callback = function(Value)
...
local Paragraph = dojoo:CreateParagraph({
	Title = "Prehistoric Island",
	Text = "Prehistoric Island"
})
local PrehistoricCheck = dojoo:CreateLabel({
   Text = "",
   Style = 1
})
...
task.spawn(function()
    while task.wait() do
        if game.Workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
            PrehistoricCheck:Set("Prehistoric Island : Spawned!")
        else
            PrehistoricCheck:Set("Prehistoric Island : Not Spawned")
        end
    end
end)

dojoo:CreateToggle({
    Name = "Prehistoric ESP",
    Description = nil,
    CurrentValue = false,
    Callback = function(Value)
...
local BoatRefreshed = seas:CreateDropdown({
    Name = "Select Boat",
    Description = Select Boats,
    CurrentValue = BoatSelected,
    Options = BoatList,
    Callback = function(Value)
        BoatSelected = Value
    end
...
local SeaLevelRefreshed = seas:CreateDropdown({
    Name = "Select Sea Level",
    Description = nil,
    CurrentValue = SeaLevelSelected,
    Options = SeaLevelList,
    Callback = function(Value)
...
seas:CreateDropdown({
    Name = "Select Weapon",
    Description = nil,
    CurrentValue = SelectWeaponSeaFarm,
    Options = WeaponList,
...
local DisSeaFarm = 30
seas:CreateSlider({
    Name = "Distance Sea Farm",
    Description = nil,
    CurrentValue = DisSeaFarm,
    Min = 10,
    Max = 100,
    Callback = function(Value)
        DisSeaFarm = Value
...
local SpeedBoatTween = 350
seas:CreateSlider({
    Name = "Tween Boat Speed",
    Description = nil,
    CurrentValue = SpeedBoatTween,
    Min = 100,
    Max = 500,
    Callback = function(Value)
...
local SpeedAllBoat = 150
seas:CreateSlider({
    Name = "Speed Boat Hack",
    Description = nil,
    CurrentValue = SpeedAllBoat,
    Min = 50,
    Max = 500,
    Callback = function(Value)
        SpeedAllBoat = Value
    ...
    if SpeedAllBoat then
        ...
        if boat and boat:FindFirstChild("VehicleSeat") then
            boat.VehicleSeat.MaxSpeed = SpeedAllBoat
        end
    end
end})
...
local MirageCheck = v4:CreateLabel({
    Text = " ",
    Style = 1
})
spawn(function()
	while task.wait() do
		if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Mirage Island") then
            MirageCheck:Set("Mirage Island : Spawned!!! ")
        else
            MirageCheck:Set("Mirage Island : Not Spawned")
        end
	end
end)

local KitsuneCheck = v4:CreateLabel({
    Text = " ",
    Style = 1
})
spawn(function()
	while task.wait() do
		if game.Workspace._WorldOrigin.Locations:FindFirstChild("Kitsune Island") then
            KitsuneCheck:Set("Kitsune Island : Spawned ")
        else
            KitsuneCheck:Set("Kitsune Island : Not Spawned ")
        end
	end
end)
...
v4:CreateToggle({
    Name = "Teleport to Advance Fruit Dealer",
    Description = nil,
    CurrentValue = TeleporttoFruitDealer,
    Callback = function(Value)
...
v4:CreateToggle({
    Name = "Teleport to Kitsune",
    Description = nil,
    CurrentValue = TeleporttoKitsune,
    Callback = function(Value)
...
v4:CreateToggle({
    ...
    Description = nil,
    CurrentValue = CollectAzureAmber,
    Callback = function(Value)
...
v4:CreateToggle({
    Name = "Teleport To Your Race Door",
    Description = nil,
    CurrentValue = RaceDoors,
    Callback = function(Value)
        RaceDoors = Value
...
mainfarm:CreateToggle({
    Name = "Level Farm No Quest",
    Description = nil,
    CurrentValue = LevelFarmNoQuest,
    Callback = function(Value)
...
mainfarm:CreateParagraph({
    Title = "Setting For Farming",
    Text = "Settings For Farming",
})
DistanceFarm = true
DistanceFarm = 50
...
mainfarm:CreateToggle({
    Name = "Bones Farm (Third Sea)",
    Description = nil,
    CurrentValue = Farm_Bone,
    Callback = function(Value)
        Farm_Bone = Value
...
mainfarm:CreateToggle({
    Name = "Ectoplasm Farm (Second Sea)",
    Description = nil,
    CurrentValue = Farm_Ectoplasm,
    Callback = function(Value)
...
local Dropdown = subfarm:CreateDropdown({
	Name = "Select Monster",
    Description = nil,
	Options = {"Select Monster"},
    CurrentOption = {"Select Monster"},
    MultipleOptions = false,
    SpecialType = nil,
    Callback = function(Options)
        _G.SelectMonster = Options
    end
})


subfarm:CreateToggle({
    Name = "Auto Farm Select Monster (Quest)",
    Description = nil,
    CurrentValue = SelectMonster_Quest_Farm,
    Callback = function(Value)
...
subfarm:CreateToggle({
    Name = "Auto Farm Select Monster (No Quest)",
    Description = nil,
    CurrentValue = SelectMonster_NoQuest_Farm,
    Callback = function(Value)
...
subfarm:CreateSlider({
    Name = "Skill Percentage %",
    Description = nil,
    CurrentValue = KillPercent,
    Callback = function(Value)
        KillPercent = Value
    end
})
...
subfarm:CreateDropdown({
    Name = "Select Method",
    Description = nil,
    Options = MasteryType,
    CurrentOption = SelectedMethodMastery,
    Callback = function(Value)
...
subfarm:CreateToggle({
    Name = "Auto Farm Devil Mastery",
    Description = nil,
    CurrentValue = DevilMastery_Farm,
    Callback = function(Value)
...
quest:CreateButton({
    ...
    Refresh_Boss:Set(NewBossList)
end})

quest:CreateToggle({
    Name = "Auto Farm Boss (Quest)",
    CurrentValue = AutoFarmBossQuest,
    Callback = function(Value)
...
quest:CreateToggle({
    ...
    CurrentValue = AutoFarmBossNoQuest,
    Callback = function(Value)
...
local EliteProgress = quest:CreateLabel({
    Text = 'Killed Boss :',
})
local EliteStatus = quest:CreateLabel({
    Text = '',
})
spawn(function()
    while task.wait() do
        if game:GetService('ReplicatedStorage'):FindFirstChild('Diablo') or game:GetService('ReplicatedStorage'):FindFirstChild('Deandre') or game:GetService('ReplicatedStorage'):FindFirstChild('Urban') then
            EliteStatus:Set("Boss Status : Boss is Spawned.")
        elseif not game:GetService('ReplicatedStorage'):FindFirstChild('Diablo') or not game:GetService('ReplicatedStorage'):FindFirstChild('Deandre') or not game:GetService('ReplicatedStorage'):FindFirstChild('Urban') then
            EliteStatus:Set("Boss Status : Boss is not Spawned.")
        end
    end
end)
...
spawn(function()
 ...
 local CakePrinceStatus = quest:CreateLabel({
    Text = 'Killed Left :',
})

quest:CreateToggle({
    Name = "Auto Cake Prince",
    CurrentValue = AutoCakePrince,
    Callback = function(Value)
...
quest:CreateToggle({
    Name = "Auto Dough King V2 Awakened (Need to Get Sweet Chalice)",
    CurrentValue = _G.AutoDoughKing,
    Callback = function(Value)
...
subfarm:CreateParagraph({
    Title = 'Auto?',
    Text = 'Auto? Idk But Just Stacks',
})
subfarm:CreateToggle({
    Name = "Auto Factory",
    CurrentValue = AutoFactory,
    Callback = function(Value)
        AutoFactory = Value
...
if #MaterialList == 0 then
    MaterialList = {"No Materials Available"} 
end

quest:CreateDropdown({
    Name = "Select Material",
    Description = "Choose a material from the list",
    CurrentOption = MaterialList[1], 
...
quest:CreateToggle({
    ...
    CurrentValue = Auto_Farm_Material,
    Callback = function(Value)
...
local ObservationRange = quest:CreateLabel({
    Text = 'Observation Level :'  .. tostring(game:GetService("Players").LocalPlayer.VisionRadius.Value),
})
spawn(function()
    while task.wait() do
        ObservationRange:Set("Observation Level : " .. tostring(game:GetService("Players").LocalPlayer.VisionRadius.Value))
    end
end)

quest:CreateToggle({
    Name = "Auto Farm Observation",
    CurrentValue = AutoFarmKen,
    Callback = function(Value)
        AutoFarmKen = Value
...
spawn(function()
    while task.wait(0.1) do
        if AutoGodhuman then
            pcall(function()
                if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or
                game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or
                game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or
                game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or
                game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or
                game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or
                game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or
                game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or
                game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or
                game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman", true) == 1 then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") and game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman").Level.Value >= 400 or
                        ...
                        game.StarterGui:SetCore("SendNotification", {
                            Title = "Notification",
                            Text = "Doesn't Have Superhuman",
                            Duration = 3
                        })
                    end
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDeathStep", true) == 1 then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Death Step") and game.Players.LocalPlayer.Backpack:FindFirstChild("Death Step").Level.Value >= 400 or
                        game.Players.LocalPlayer.Character:FindFirstChild("Death Step") and game.Players.LocalPlayer.Character:FindFirstChild("Death Step").Level.Value >= 400 then
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate")
                        end
                    else
                        game.StarterGui:SetCore("SendNotification", {
                            Title = "Notification",
                            Text = "Doesn't Have Death Step",
                            Duration = 3
                        })
                    end
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySharkmanKarate", true) == 1 then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Sharkman Karate").Level.Value >= 400 or
                        ...
                        game.StarterGui:SetCore("SendNotification", {
                            Title = "Notification",
                            Text = "Doesn't Have SharkMan Karate",
                            Duration = 3
                        })
                    end
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectricClaw", true) == 1 then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") and game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw").Level.Value >= 400 or
                        ...
                        game.StarterGui:SetCore("SendNotification", {
                            Title = "Notification",
                            Text = "Doesn't Have Electric Claw",
                            Duration = 3
                        })
                    end
                    if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyDragonTalon", true) == 1 then
                        if game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon") and game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Talon").Level.Value >= 400 or
                        game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon") and game.Players.LocalPlayer.Character:FindFirstChild("Dragon Talon").Level.Value >= 400 then
                            if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman", true), "Bring") then
                                game.StarterGui:SetCore("SendNotification", {
                                    Title = "Notification",
                                    Text = "Doesn't Have Enough Material",
                                    Duration = 3
                                })
                            else
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyGodhuman")
                        ...
                        game.StarterGui:SetCore("SendNotification", {
                            Title = "Notification",
                            Text = "Doesn't Have Dragon Talon",
                            Duration = 3
                        })
                    end
                else
...
quest:CreateToggle({
    ...
    CurrentValue = AutoLegendarySword,
    Callback = function(Value)
...
local TushitaSword = quest:CreateLabel({
    Text = "Tushita Sword : ",
    Style = "1"
})

     
local YamaSword = quest:CreateLabel({
    Text = "Yama Sword : ",
    Style = "1"
})
...
spawn(function()
    while task.wait() do
        if GetWeaponInventory("Tushita") == true then
            TushitaSword:Set("Tushita Sword : Have âœ…")
        elseif GetWeaponInventory("Tushita") == false then
            TushitaSword:Set("Tushita Sword : Doesnt Have âŒ")
        end

        if GetWeaponInventory("Yama") == true then
            YamaSword:Set("Yama Sword : Have âœ…")
        elseif GetWeaponInventory("Yama") == false then
            YamaSword:Set("Yama Sword : Doesnt Have âŒ")
        end
        wait(300)
    end
end)
...
quest:CreateToggle({
    Name = "Auto Tryluck Gravestone",
    CurrentValue = AutoTryLuck,
    Callback = function(Value)
        AutoTryLuck = Value
...
quest:CreateToggle({
    Name = "Auto Advanced Dungeon Pheonix",
    CurrentValue = AutoAdvanceDungeon,
    Callback = function(Value)
...
quest:CreateToggle({
    Name = "Auto Color Haki",
    CurrentValue = AutoColorHaki,
    Callback = function(Value)
        AutoColorHaki = Value
    end
})
...
raid:CreateDropdown({
    Name = "Select Weapon",
    CurrentOption = RaidSelectedWeapon,
    Options = RaidWeaponList,
    Callback = function(Value)
...
Law_Raids:AddSlider("Distance Farm", 1, 100, 10, function(Value)
    DisRaid = Value
end)
...
raid:CreateToggle({
    Name = "Auto Buy Microchips",
    CurrentValue = AutoBuySpecialChip,
    Callback = function(Value)
...
raid:CreateToggle({
    Name = 'Auto Awaken',
    CurrentValue = AutoAwakenAbilities,
    Callback = function(Value)
...
local Current = combat:CreateLabel({
    Name = "Current Bounties : ",
    Text = "Current Bounties : "
})
local Earn = combat:CreateLabel({
    Name = "Bounty Earned : ",
    Text = "Bounty Earned : "
})
...
combat:CreateDropdown({
    Name = "Select Weapon",
    CurrentValue = PvpSelectedWeapon,
    Options = PvpWeaponList,
    Callback = function(Value)
...
AutoPvpType = "Behind"
combat:CreateDropdown({
    Name = "Select Pvp Type",
    CurrentValue = AutoPvpType,
    Options = PvpTable,
    Callback = function(Value)
        AutoPvpType = Value
    end
...
local DropdownPlayer = combat:CreateDropdown({
    Name = "Select Player",
...
combat:CreateButton({
	...
	DropdownPlayer:Set(NewPlayerList)
end})

combat:CreateToggle({
    Name = "Spectate Player",
    CurrentValue = Spectate,
    Callback = function(value)
        Spectate = value
...
combat:CreateToggle({
    Name = "Aimbot Skill",
    CurrentValue = AimbotSkillPlayer,
    Callback = function(Value)
...
local Island_Teleport = tst:AddSection('Island Teleport', 'right')
if First_Sea then
    IslandCheck = {
        "Start Island";
        "Marine Start";
...
local NPCSelecRefresh = tst:CreateDropdown({
    Name = "Select Npc",
    CurrentValue = SelectedNpc,
    Options = NPCLIST,
    Callback = function(Value)
        SelectedNpc = Value
    end
...
tst:CreateParagraph({
 ...
 RaceStatus = tst:CreateParagraph({
    Text = "",
    Style = "1"
})
local PointStatus = tst:CreateParagraph({
    Text = "",
    Style = "1"
})  
local StatusFunc1 = tst:CreateParagraph({
    Text = "",
    Style = "1"
})
local StatusFunc2 = tst:CreateParagraph({
    Text = "",
    Style = "1"
})
local StatusFunc3 = tst:CreateParagraph({
    Text = "",
    Style = "1"
})
spawn(function()
    while wait() do
        RaceStatus:Set("Race : "..tostring(game:GetService("Players").LocalPlayer.Data.Race.Value))
        PointStatus:Set("Points Avaible : "..tostring(game:GetService("Players").LocalPlayer.Data.Points.Value)..' Point')
        StatusFunc1:Set("Melee : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats.Melee:WaitForChild("Level").Value)..' Point Left')
        StatusFunc2:Set("Defense : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats.Defense:WaitForChild("Level").Value)..' Point')
        StatusFunc3:Set("Sword : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats.Sword:WaitForChild("Level").Value)..' Point')
        StatusFunc4:Set("Gun : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats.Gun:WaitForChild("Level").Value)..' Point')
        StatusFunc5:Set("Devil Fruit : "..tostring(game:GetService("Players").LocalPlayer.Data.Stats["Demon Fruit"]:WaitForChild("Level").Value)..' Point')
    end
end)
 tst:CreateSlider({
    Name = "Set Point",
...
shop:CreateButton({
    Name = "Random Race [ f3000 Fragments ]",
    Callback = function()
        local args = {
            [1] = "BlackbeardReward",
        [2] = "Reroll",
...
shop:CreateButton({
    Name = "Reset Stats [ f2500 Fragments ]",
    Callback = function()
        local args = {
            [1] = "BlackbeardReward",
        [2] = "Refund",
...
shop:CreateButton({
    Name = "Superhuman [ $3,000,000 Beli ]",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
    end
})
...
local PriceDevFruit = shop:CreateLabel({
    Text = "Fruit Price : -",
    Style = "1",
    ...
    while task.wait() do
        for i,v in next,Remote_GetFruits do
            if v.Name == Select_Devil_Fruit then
                PriceDevFruit:Set('Fruit Price : $' .. v.Price)
            end
        end
    end
end)

local DevilShopsRefresh = shop:CreateDropdown({
    Name = "Select Devil Fruit on Sale",
    Options = ShopDevilSell,
...
shop:CreateButton({
    Name = "Set Fruit on Sale",
    Callback = function()
        DevilShopsRefresh:Set(ShopDevilSell)
    end
})

shop:CreateButton({
    Name = "Buy Devil Fruit on Sale",
    Callback = function()
...
function StoredFruited(stori, stari)
    local Character = game:GetService("Players").LocalPlayer.Character
    local Backpack = game:GetService("Players").LocalPlayer.Backpack
    local CommF_ = game:GetService("ReplicatedStorage").Remotes.CommF_
    if Character:FindFirstChild(stari) or Backpack:FindFirstChild(stari) then
        local args = {
            [1] = "StoreFruit",
            [2] = stori,
            [3] = Character:FindFirstChild(stari) or Backpack:FindFirstChild(stari) 
        }
...
misc:CreateToggle({
    Name = "Devil Fruit ESP (Red Color)",
    Default = _G.ESPDF,
    Callback = function(Value)
        _G.ESPDF = Value
    end
